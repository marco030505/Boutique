...
const PAGE_TITLES: Record<string, { title: string; breadcrumb: string }> = {
  ...
  '/dashboard/configuracion': { title: 'Configuración', breadcrumb: 'Configuración del sistema' },
};
...
export default function DashboardLayout() {
  ...
  const pageInfo = PAGE_TITLES[location.pathname] ?? { title: 'Panel', breadcrumb: location.pathname };
      ...
      <aside className="sidebar" aria-label="Menú principal">
        <div className="sidebar-header">
          ...
          <div className="sidebar-brand-text">
            ...
            <span className="sidebar-brand-sub">&amp; Luca Fashion</span>
          </div>
        </div>
        ...
        <nav className="sidebar-nav" role="navigation">
          <div className="sidebar-nav-section">
            ...
            <NavLink id="nav-dashboard" to="/dashboard" end className={({ isActive }) => `sidebar-nav-item${isActive ? ' active' : ''}`}>
              <span className="sidebar-nav-icon"><IconGrid /></span>
              Dashboard
            </NavLink>

            <NavLink id="nav-ventas" to="/dashboard/ventas" className={({ isActive }) => `sidebar-nav-item${isActive ? ' active' : ''}`}>
              <span className="sidebar-nav-icon"><IconShoppingBag /></span>
              Ventas
            </NavLink>

            <div id="nav-inventario" className="sidebar-nav-item">
              <span className="sidebar-nav-icon"><IconPackage /></span>
              Inventario
              <span className="sidebar-nav-badge">Próximo</span>
            </div>

            <div id="nav-productos" className="sidebar-nav-item">
              <span className="sidebar-nav-icon"><IconTag /></span>
              Productos
              <span className="sidebar-nav-badge">Próximo</span>
            </div>
          </div>
          ...
          {isAdmin && (
            <div className="sidebar-nav-section">
              ...
              {[
                ...
                <div key={item.id} id={`nav-${item.id}`} className="sidebar-nav-item">
      ...
      <div className="dashboard-main">
        <header className="dashboard-header">
          <div className="dashboard-header-left">
            <span className="dashboard-header-page-title">{pageInfo.title}</span>
            <span className="dashboard-header-breadcrumb">
              Memo's Style &amp; Luca Fashion / {pageInfo.breadcrumb}
            </span>
          </div>
          <div className="dashboard-header-right">
            <div className="user-info-pill">
              ...
              <div className="user-info-text">
                ...
                <span className={`user-role-badge user-role-badge--${session?.role}`}>
                  {session?.role}
                </span>
              </div>
            </div>
